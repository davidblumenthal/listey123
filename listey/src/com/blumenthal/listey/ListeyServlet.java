	...
	*/
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException{
        ...
        if (user != null) {
        	...
        	Gson gson = new Gson();
        	ListeyData data = gson.fromJson(passedSerializedHash, ListeyData.class);
        	log.info("doPost: listeyData.lastUpdate = " + data.lastUpdate);
        	Set<String> listNames = data.lists.keySet();
